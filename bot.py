...
async def send_info_post():
    text = (
         "📌 <b>Важная информация над закрепленным постом:</b>\n\n"
        "🔹 Условия для команд\n"
        "🔹 Почему выбирают нас\n"
        "🔹 Обзор платформы\n\n"
        "👇 Нажмите на кнопку ниже, чтобы ознакомиться.\n"
        "После перехода пролистайте вниз — там подробности о нашем софте и условиях для трейдеров."
    )
